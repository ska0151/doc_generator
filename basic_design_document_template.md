# 【新】組込みソフトウェア基本設計書 (Basic Design)

## 1. はじめに
*   **本書の目的:** システム全体のアーキテクチャ、リソース割り当て、および共通の設計方針を定義する。
*   **準拠する要求仕様:** [要求仕様書ID/リンク]
*   **用語定義:** プロジェクト固有の略語リスト。
...
### 4.2. パフォーマンス目標
*   **CPU負荷率:** 平均50%以下、ピーク時80%以下。
*   **起動時間:** 電源投入からReady状態まで500ms以内。
...
### 5.3. 再起動・初期化戦略
*   **リセットハンドリング:** 電源投入、WDTリセット、ソフトウェアリセット、低電圧検知時のそれぞれの挙動の差別化。
